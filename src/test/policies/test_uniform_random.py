...
class TestUniformRandom:
    def test_choice(self):
        uniform = UniformRandom(num_actions=2, rng=Generator(PCG64(40)))
    ...
    def test_update(self):
        ...
        assert_array_equal(uniform.cumulative_rewards, [0.0, 1.0])
        assert_array_equal(uniform.action_stats, [0, 1])
